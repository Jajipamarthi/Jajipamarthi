...
The plot below shows the count of accidents per each year. The accidents were high in late 1900's and decrease in 2000's.
Limitation: The data is not clear on x-axis. The plot has to be scaled along with better visualization parameters such aas color and labels can improve the understanding of the plot.
```{r}
